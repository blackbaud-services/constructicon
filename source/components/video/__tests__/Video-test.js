...
describe("Video", () => {
  it("renders a simple video", () => {
    ...
    expect(wrapper.find(`.${rootClass}`).html()).to.contain(
      "youtube.com/embed"
    );
  });
  ...
  it("renders a simple video from oembed", () => {
    const wrapper = mount(
      <Video
        embed={{
          html: '<iframe width="480" height="270" src="https://www.youtube.com/embed/bYX3-RE9s9E?feature=oembed" frameborder="0" allowfullscreen="allowfullscreen"></iframe>',
          width: 480,
          height: 270,
  ...
  it("correctly calculates aspect ratio", () => {
    const wrapper = mount(
      <Video
        embed={{
          html: '<iframe src="https://player.vimeo.com/video/243244233?app_id=122963" width="426" height="240" frameborder="0" allow="autoplay; fullscreen" allowfullscreen title="Unexpected Discoveries"></iframe>',
          width: 480,
          height: 240,
