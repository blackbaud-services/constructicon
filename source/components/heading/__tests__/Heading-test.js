...
describe('Heading', () => {
  ...
  it('should apply custom styles', () => {
    ...
    const wrapper = mount(<Heading styles={customStyles}>'Informative Section Heading'</Heading>)
  ...
  it('should apply an id', () => {
    const wrapper = mount(<Heading id='section'>Informative Section Heading</Heading>)
